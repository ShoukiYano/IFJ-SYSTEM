...
export default function AppShell({ children }: AppShellProps) {
    ...
    // サイドバーを表示しない公開ページやログインページの判定
    const isPublicPage = pathname.startsWith('/public/') || pathname.startsWith('/admin-portal');
    ...
    return (
        <div className="flex flex-col min-h-screen bg-slate-50">
            ...
            <div className="flex flex-1">
                ...
                <main className={`flex-1 ${isPublicPage ? "" : "md:ml-64 pt-16 md:pt-0"}`}>
